...
class SellerController extends Controller
{
    ...
    {
        $order = Seller::findOrFail($request->id);
        $order->verification = $request->verification;
        if ($request->verification == "verified") {
            Toastr::success('Seller has been Verified successfully');
        } else if ($request->verification == "unverified") {
            Toastr::info('Seller has been Unverified successfully');
        } 
        $order->save();
        return back();
    }
