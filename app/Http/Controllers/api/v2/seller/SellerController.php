...
class SellerController extends Controller
{
    ...
    public function seller_info_update(Request $request)
    {
        ...
        Seller::where(['id' => $seller['id']])->update([
            ...
            'active_facebook' => $request['active_facebook'],
            'twitter' => $request['twitter'],
            'active_twitter' => $request['active_twitter'],
            'instagram' => $request['instagram'],
            'active_instagram' => $request['active_instagram'],
            'tiktok' => $request['tiktok'],
            'active_tiktok' => $request['active_tiktok'],
            'active_whatsapp' => $request['active_whatsapp'],
            'website_url' => $request['website_url'] ,
            'active_website_url' => $request['active_website_url'],
            'facebook' => $request['facebook'],
            'active_facebook' => $request['active_facebook'],
            'twitter' => $request['twitter'],
            'active_twitter' => $request['active_twitter'],
