                        ...
                        @if($product->images!=null)
                            @foreach (json_decode($product->images) as $key => $photo)
                                <div
                                    ...
                                    id="image{{$key}}">
                                    <img class="cz-image-zoom img-responsive" style="height: 400px"
        ...
        <div class="container mt-4 rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
            ...
            <div class="row  d-flex align-items-center" id="sellerOption">
                <div class="col-md-6">
                    <div class="seller_shop">
                        ...
                        <div class="shop-name-{{Session::get('direction') === "rtl" ? 'right' : 'left'}} d-flex justify-content-center align-items-center">
                            <div>
                                
                                    <div class="title row">
                                        <a href="#" class="d-flex align-items-center">{{$product->seller->shop->name}}</a> 
                                        &nbsp;&nbsp;
                                        @if($product->seller->verification=='verified')
                ...
                <div class="text-center col-lg-3 col-md-2 col-12 row font-weight-bold flex-row-reverse" style="font-size: 44px; ">
                    @if($product->seller->active_facebook)
                        <div class="col-lg-2 col-md-4 col-12 slhov">
                            <!-- Facebook -->
                            <a href="{{$product->seller->facebook}}" target="_blank" ><i class="fa fa-facebook-f"></i></a>
                            
                        </div >
                    @endif
                    @if($product->seller->active_instagram)
                        <div class="col-lg-2 col-md-4 col-12 slhov">
                            <!-- Twitter -->
                            <a href="{{$product->seller->instagram}}" target="_blank" > <i class="fa fa-twitter"></i></i></a>
                        </div>
                    @endif
                    @if($product->seller->active_twitter)
                        <div class="col-lg-2 col-md-4 col-12 slhov"> 
                            <!-- Instagram -->
                            <a href="{{$product->seller->instagram}}" target="_blank" > <i class="fa fa-instagram"></i></i></i></a>
                        </div>
                    @endif
                    @if($product->seller->active_tiktok)
                        <div class="col-lg-2 col-md-4 col-12 slhov"> 
                            <!-- Instagram -->
                            <!-- tiktok -->
                                <a href="{{$product->seller->tiktok}}" target="_blank" class='mb-1' > <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-tiktok" viewBox="0 0 20 20">
                                    <path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3V0Z"/>
                                </svg></i></a>
                        </div>
                    @endif
                    @if($product->seller->active_whatsapp)
                        <div class="col-lg-2 col-md-4 col-12 slhov"> 
                            <!-- Instagram -->
                            <a href="whatsapp://send?phone={{$product->seller->phone}}" data-action="share/whatsapp/share"><i class="fa fa-whatsapp"></i></a>
                        </div>
                    @endif
                    </div>
                <div class="col-md-3 p-md-0 pt-sm-3 ">
            ...
            <div class="row">
                    <div class="col-lg-12 col-md-2 col-12 ">
                        <div class="text-{{Session::get('direction') === "rtl" ? 'right' : 'left'}} pt-3"> <p class="" >{{$product->seller->bio}}<p></div>
                    </div>
            </div>
            </div>
