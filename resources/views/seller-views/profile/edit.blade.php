                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9 row">
                                    <div class="col-sm-8">
                                        <small class="text-danger">( * {{\App\CPU\translate('country_code_is_must')}} {{\App\CPU\translate('like_for_BD_880')}} )</small>
                                    ...
                                    <div class="col-sm-4  row mt-4" >
                                            <label class="font-weight-bold" for="active_whatsapp " style="font-size: 22px;">whatsapp</label>
                                            <input class=" form-control col-sm-3" type="checkbox" name="active_whatsapp" id='active_whatsapp'
                                                @if($data->active_whatsapp==1) checked @endif>
                            ...
                            <div class="row form-group">
                                <label for="newEmailLabel"
                                       class="col-sm-3 col-form-label input-label">{{\App\CPU\translate('Bio')}}</label>

                                <div class="col-sm-9">
                                    <textarea class="form-control" name="bio" id="bio" 
                                    placeholder="{{\App\CPU\translate('Enter you Bio')}}" aria-label="Enter you Bio">{{$data->bio}}</textarea>
                            ...
                            <div class="row form-group">
                                <label for=""
                                       class="col-sm-3 col-form-label input-label">{{\App\CPU\translate('Facebook url')}}</label>
                                <div class="col-sm-9 row">
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="facebook" id="facebook"
                                            value="{{$data->facebook}}"
                                            placeholder="{{\App\CPU\translate('Enter your facebook address')}}" aria-label="Enter your facebook address">
                                    </div>
                                           <div class="col-sm-4  row" >
                                               <label class="font-weight-bold" for="active_facebook " style="font-size: 22px;">Active</label>
                                               <input class=" form-control col-sm-3" type="checkbox" name="active_facebook" id='active_facebook'
                                               @if($data->active_facebook ==1) checked @endif>
                            ...
                            <div class="row form-group">
                                <label for=""
                                       class="col-sm-3 col-form-label input-label">{{\App\CPU\translate('twitter url')}}</label>
                                <div class="col-sm-9 row">
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="twitter" id="twitter"
                                            value="{{$data->twitter}}"
                                            placeholder="{{\App\CPU\translate('Enter your twitter url')}}" aria-label="Enter your twitter url">
                                    </div>
                                        <div class="col-sm-4  row" >
                                            <label class="font-weight-bold" for="active_twitter " style="font-size: 22px;">Active</label>
                                            <input class=" form-control col-sm-3" type="checkbox" name="active_twitter" id='active_twitter'
                                            @if($data->active_twitter ==1) checked @endif>
                            ...
                            <div class="row form-group">
                                <label for=""
                                       class="col-sm-3 col-form-label input-label">{{\App\CPU\translate('Instagram url')}}</label>
                                <div class="col-sm-9 row">
                                    <div class="col-sm-8">
                                    <input type="text" class="form-control" name="instagram" id="instagram"
                                           value="{{$data->instagram}}"
                                           placeholder="{{\App\CPU\translate('Enter your Instagram address')}}" aria-label="Enter your Instagram address">
                                    </div>
                                        <div class="col-sm-4  row" >
                                            <label class="font-weight-bold" for="active_instagram " style="font-size: 22px;">Active</label>
                                            <input class=" form-control col-sm-3" type="checkbox" name="active_instagram" id='active_instagram'
                                            @if($data->active_instagram ==1) checked @endif>
                            ...
                            <div class="row form-group">
                                <label for=""
                                       class="col-sm-3 col-form-label input-label">{{\App\CPU\translate('Tiktok_url')}}</label>
                                <div class="col-sm-9 row">
                                    <div class="col-sm-8">
                                    <input type="text" class="form-control " name="tiktok" id="tiktok"
                                           value="{{$data->tiktok}}"
                                           placeholder="{{\App\CPU\translate('Enter your tiktok address')}}" aria-label="Enter your tiktok address">
                                    </div>
                                    <div class="col-sm-4  row" >
                                        <label class="font-weight-bold" for="active_tiktok " style="font-size: 22px;">Active</label>
                                        <input class=" form-control col-sm-3" type="checkbox" name="active_tiktok" id='active_tiktok'
                                        @if($data->active_tiktok ==1) checked @endif>
                            ...
                            <div class="row form-group">
                                <label for=""
                                       class="col-sm-3 col-form-label input-label">{{\App\CPU\translate('website_url')}}</label>
                                <div class="col-sm-9 row">
                                    <div class="col-sm-8">
                                    <input type="text" class="form-control " name="website_url" id="website_url"
                                           value="{{$data->website_url}}"
                                           placeholder="{{\App\CPU\translate('Enter your website url')}}" aria-label="Enter your website url">
                                    </div>
                                    <div class="col-sm-4  row" >
                                        <label class="font-weight-bold" for="active_website_url " style="font-size: 22px;">Active</label>
                                        <input class=" form-control col-sm-3" type="checkbox" name="active_website_url" id='active_website_url'
                                        @if($data->active_website_url ==1) checked @endif>
                            ...
                            <div class="row form-group">
                                <label for=""
                                       class="col-sm-3 col-form-label input-label">{{\App\CPU\translate('map_location_url')}}</label>
                                <div class="col-sm-9 row">
                                    <div class="col-sm-8">
                                    ...
                                    <div class="col-sm-4  row" >
                                        <label class="font-weight-bold" for="active_map_location " style="font-size: 22px;">Active</label>
                                        <input class=" form-control col-sm-3" type="checkbox" name="active_map_location" id='active_map_location'
                                        @if($data->active_map_location ==1) checked @endif>
