                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        ...
                        <form class="user" action="{{route('shop.apply')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0 ">
                                    <select class="form-control form-control-user" id="country_name" name="country_id" required>
                                ...
                                <div class="col-sm-6 mb-3 mb-sm-0 ">
                                    <select class="form-control form-control-user" id="city_name" name="city_id" required disabled>
                                        <option value="">{{\App\CPU\translate('Select_city')}}</option>
                                    </select>
                                </div>
...
<script>
    ...
    var country_id = this.value;
        ...
        $.ajax({
            ...
            $('#city_name').html('<option value="">Select State</option>');
            console.log(result); 
            $.each(result.governments,function(key,value){
