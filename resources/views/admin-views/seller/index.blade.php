                        ...
                        <div class="table-responsive">
                            <table
                                ...
                                <tr>
                                    ...
                                    <th scope="col">{{\App\CPU\translate('verification')}}</th>
                                ...
                                @foreach($sellers as $key=>$seller)
                                    <tr>
                                        ...
                                        <td scope="col">
                                            {!! $seller->verification=='verified'?'<label class="badge badge-success">verified</label>':'<label class="badge badge-danger">Not-verified</label>' !!}
                                        </td>
                                        <td scope="col">
                                            <a href="{{route('admin.sellers.order-list',[$seller['id']])}}"
                                               class="btn btn-outline-primary btn-block">
                                                <i class="tio-shopping-cart-outlined"></i>( {{$seller->orders->where('order_type','default_type')->count()}})
                                            </a>
                                        </td>
                                        <td scope="col">
