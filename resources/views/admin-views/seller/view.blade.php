                ...
                @elseif ($seller->status=="approved")
                    @if($seller->verification!="verified")
                        <div class="mt-4 pr-2 float-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}">
                            <div class="flex-start">
                                <h4 class="mx-1"><i class="tio-shop-outlined"></i></h4>
                                <div><h4>{{\App\CPU\translate('Check_Seller_as_Verified.')}}</h4></div>
                            </div>
                            <div class="text-center">
                                <form class="d-inline-block" action="{{route('admin.sellers.updateVerification')}}" method="POST">
                                    @csrf
                                    <input type="hidden" name="id" value="{{$seller->id}}">
                                    <input type="hidden" name="verification" value="verified">
                                    <button type="submit" class="btn btn-success">{{\App\CPU\translate('verify')}}
                    ...
                    @else
                        <div class="mt-4 pr-2 float-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}">
                            <div class="flex-start">
                                <h4 class="mx-1"><i class="tio-shop-outlined"></i></h4>
                                <div><h4>{{\App\CPU\translate('Seller_is_now_Verified.')}}</h4></div>
                            </div>
                            <div class="text-center">
                                <form class="d-inline-block" action="{{route('admin.sellers.updateVerification')}}" method="POST">
                                    @csrf
                                    ...
                                    <button type="submit" class="btn btn-danger">{{\App\CPU\translate('unverify')}}</button>
                                </form>
                            </div>
                        </div>
                    @endif
